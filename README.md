...
Esse site foi desenvolvido codando por observação tendo um site de referência, foram utilizados HTML, CSS, Js, um pouco de PHP e Ajax, em um total de 6 telas.  
